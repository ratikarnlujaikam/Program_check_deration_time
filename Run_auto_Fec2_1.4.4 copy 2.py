...
def submit_action():
    ...
    print("selected_duration1**********before***********",selected_duration)
    save_values()
    print("selected_duration2**********after************",selected_duration)
    # save_values_temp()
    ...
    if file_exists(stop_file_path):
        try:
            ...
            print("selected_duration4*********************************affter*******************************",selected_duration)
            if current_hour == stop_hour:
                print("selected_duration5*********************************before*******************************",selected_duration)
                # save_values_temp()
                # save_values_temp_time()
                duration_var.set(nexttime)
                
                nexttime_set = True
                print("if current_hour == stop_hour:", nexttime)
                print("selected_duration6*********************************affter*******************************",selected_duration)
...
def submit_stop():
    ...
    if password and password == '1a2b3d4e':
        ...
        selected_duration = duration_var.get()
        print("selected_duration*****************b****************save_values_temp()*****************************", selected_duration)
        save_values_temp()
        print("selected_duration*****************a****************save_values_temp()*****************************", selected_duration)
       
        # save_values_temp_time()
        # submit_action()
        print("selected_duration*********************************b**submit_action()*****************************", selected_duration)
        submit_action()
        submit_action()
        print("selected_duration*********************************a**submit_action()*****************************", selected_duration)
        save_values()
        print("selected_duration*********************************a**save_values()*****************************", selected_duration)
