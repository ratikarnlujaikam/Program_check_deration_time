...
def submit_action():
    ...
    if file_exists(stop_file_path):
        try:
            ...
            print("selected_duration*********************************before*******************************",selected_duration)
            if current_hour == stop_hour:
                ...
                print("selected_duration*********************************affter*******************************",selected_duration)
                
            else:
                # If current hour does not match stop hour, set duration_var to selected_duration
                duration_var.set(selected_duration)
                print("else current_hour == stop_hour:", selected_duration)
...
version_label = ttk.Label(frame, text="V.1.4.1")
